...
RUN pip install -q opencv-python imageio imageio-ffmpeg ffmpeg-python av runpod \
    ...
    aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/camenduru/stable-diffusion-3.5-large/resolve/main/sd3.5_large.safetensors -d /content/ComfyUI/models/vae -o sd3.5_large.safetensors
